...
public class Helpers {
    ...
    public static File getFilesystemRoot(String path) {
        ...
        File[] dirFile = OgleApplication.getInstance().getExternalFilesDirs("");
    ...
    private static String generateFilePath(String basePath, String url, String contentDisposition, String contentLocation, String mimeType,
                                           int destination, long contentLength) throws GenerateSaveFileError {
    ...
    private static void checkCanHandleDownload(Context context, String mimeType, int destination, boolean isPublicApi)
            throws GenerateSaveFileError {
        if (isPublicApi) {
            return;
        }
...
//        filename = filename.replaceFirst("/+", "/"); // normalize leading slashes
//        File[] dirFile = HotSpotApplication.getInstance().getExternalFilesDirs("");
//        boolean flag = false;
//        for (File file: dirFile){
////            Log.i("DownloadManager","file: " + file.getPath());
//            if(filename.startsWith(file.getPath())){
//                flag = true;
//                break;
//            }
//        }
