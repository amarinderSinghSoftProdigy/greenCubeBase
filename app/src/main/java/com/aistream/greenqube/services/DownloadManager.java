...
package com.aistream.greenqube.services;
...
import com.aistream.greenqube.services.downloads.Downloads;
...
//    public static final String COLUMN_QUALITYID = "qualityid";
    ...
    public final static int ERROR_FILE_MISSING = 1011;
     ...
     * start.
     */
    public final static String ACTION_DOWNLOAD_START = "android.intent.action.DOWNLOAD_START";
    ...
    private static final String[] COLUMNS = new String[]{COLUMN_ID,
            ...
            COLUMN_LAST_MODIFIED_TIMESTAMP, COLUMN_MOVIEID};
    ...
    private static final String[] UNDERLYING_COLUMNS = new String[]{
            ...
            Downloads.COLUMN_FILE_NAME_HINT, Downloads._DATA, Downloads.COLUMN_MOVIEID};
...
//        private int typeDown;

        /**
         * @param uri the HTTP/HTTPS/SMB URI to download.
         */
...
//                    typeDown = 1;
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Can only download HTTP/HTTPS/SMB URIs: " + uri);
            }
        }
        ...
        public Request setDestinationFilesDir(Context context, String dirType, String subPath) {
//            File root = new File(dirType + File.separator + "/Android/media/" + context.getPackageName() + "/files/");
//            mDestinationUri = Uri.withAppendedPath(Uri.fromFile(root), subPath);
            File[] dirFile = context.getExternalFilesDirs("");
            boolean flag = false;
            for (File file : dirFile) {
                if (file.getPath().startsWith(dirType)) {
                    flag = true;
        ...
        public Request setDescription(int mvId) {
            this.mvId = mvId;
//            this.qualityId = qualityId;
        ...
        ContentValues toContentValues(String packageName) {
            ...
            if (mDestinationUri != null) {
                ...
                values.put(Downloads._DATA, mDestinationUri.getPath());
            } else {
                values.put(Downloads.COLUMN_DESTINATION,
            ...
            if (!mRequestHeaders.isEmpty()) {
                encodeHttpHeaders(values, mRequestHeaders);
            }
            ...
            values.put(Downloads.COLUMN_MOVIEID, mvId);
//            values.put(Downloads.COLUMN_QUALITYID, qualityId);
//            values.put(Downloads.COLUMN_TYPEDOWNLOAD, typeDown);

            return values;
        }

        public static void encodeHttpHeaders(ContentValues values, List<Pair<String, String>> mRequestHeaders) {
            int index = 0;
     ...
     *
     * @param id the ID of the download
     * @param request dowmload request
     * @hide
     */
    public void restartDownload(long id, Request request) {
        ...
        ContentValues values = request.toContentValues(mPackageName);
        values.put(Downloads.COLUMN_STATUS, Downloads.STATUS_PENDING);
        mResolver.update(mBaseUri, values, getWhereClauseForIds(id),
                getWhereArgsForIds(id));
    }
    ...
    private static class CursorTranslator extends CursorWrapper {
        ...
        private long translateLong(String column) {
            ...
            if (column.equals(COLUMN_MOVIEID)) {
                return (int) getUnderlyingLong(Downloads.COLUMN_MOVIEID);
            }
//            if (column.equals(COLUMN_QUALITYID)) {
//                return (int) getUnderlyingLong(Downloads.COLUMN_QUALITYID);
//            }
