...
public class Constants {
    ...
    public static final int MAX_DOWNLOADS_SAME_TIME = 1;

    public volatile static int countThreadDownload;
    ...
    public static final boolean LOGV = /*Config.LOGV
            || (Config.LOGD && LOCAL_LOGV && Log.isLoggable(TAG, Log.VERBOSE))*/false;
