        ...
        private void createDownloadsTable(SQLiteDatabase db) {
            try {
                ...
                db.execSQL("CREATE TABLE " + DB_TABLE + "(" + Downloads._ID
                        ...
                        + Downloads.COLUMN_MOVIEID + " INTEGER); "
                );
//                        + Downloads.COLUMN_TYPEDOWNLOAD + " INTEGER); ");
    ...
    public boolean onCreate() {
        Log.v(Constants.TAG, "populating new database + " + getContext());
...
//            }
        ...
        copyInteger(Downloads.COLUMN_MOVIEID, values, filteredValues);
//        copyInteger(Downloads.COLUMN_QUALITYID, values, filteredValues);
//        copyInteger(Downloads.COLUMN_TYPEDOWNLOAD, values, filteredValues);
...
//        }
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (whereArgs != null && whereArgs.length > 0) {
            ...
            for(String idStr: whereArgs) {
                insertRequestHeaders(db, Integer.valueOf(idStr), values);
            }
