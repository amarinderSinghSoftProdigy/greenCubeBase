...
public class ItemAdapterMovie extends RecyclerView.Adapter<ItemAdapterMovie.Viewholder> {
    ...
    public ItemAdapterMovie(Context cont, List<MovieInfo> movieInfoList, ViewLibrary viewLibrary, boolean isMovie) {
        this.mContext = cont;
    ...
    public Viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(isMovie? R.layout.item_contentlibrary: R.layout.item_continuewatching, parent, false);
    ...
    public void onBindViewHolder(final Viewholder holder, int position) {
        ...
        viewLibrary.showMovieVIP(holder.tv_vip, movieInfo);
        ...
        holder.im_itemmovie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                viewLibrary.showMovieDetail(movieInfo);
            }
        });

        String imgUrl = movieInfo.getPoster();
        if (!isMovie) {
            imgUrl = movieInfo.getPreview();
        }
        Picasso.with(mContext).load(Config.picURLPath + imgUrl).fit().centerCrop().networkPolicy(NetworkPolicy.OFFLINE).config(Bitmap.Config.RGB_565).error(R.drawable.preview_2).placeholder(R.drawable.preview_2).into(holder.im_itemmovie, new Callback() {
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(View itemView) {
            ...
            if (!isMovie) {
                itemView.findViewById(R.id.iv_play).setVisibility(View.GONE);
            }
        }
    }
}
