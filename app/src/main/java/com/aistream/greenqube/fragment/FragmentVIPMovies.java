...
public class FragmentVIPMovies extends Fragment implements ViewLibrary, View.OnClickListener {
    private String TAG = "FragmentVIPMovies";
    ...
    public FragmentVIPMovies() {
        super();
    }

    @SuppressLint("ValidFragment")
    public FragmentVIPMovies(PresenterMainImp presenterMainImp, ViewMain viewMain) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLibraryImp = new PresenterLibraryImp(getContext(), this,
                presenterMainImp, null, PresenterLibraryImp.VIP);
